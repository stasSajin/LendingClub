...
You can see below the VARImp for the top 15 predictors in XGBoost and how feature that identifies if a comment is present comes among the top 10:

![](lessons_learned_files/figure-html/varImp.png)

The models created in this section are just a starting point. Future improvement could:
